...
- For very long text, vertical scroll is prioritized (to avoid clipping at the round bottom edge), with extra safe bottom padding and wider horizontal insets.
